...
curl_close( $ch );
$bodytag = str_replace( "((?!vmoney-slotik\.net/b)\w+(?:\.\w+)+", "https://avtomatyluck.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "avtomatyluck.azurewebsites.net", $contents );
