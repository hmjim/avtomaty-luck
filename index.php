...
curl_close( $ch );
$bodytag = str_replace( "((?!vmoney-slotik\.net/b)\w+(?:\.\w+)+", "https://avtomatylucks.azurewebsites.net/", $contents );
$result  = preg_replace( '~' . $new_url . '~m', "avtomatylucks.azurewebsites.net", $contents );
